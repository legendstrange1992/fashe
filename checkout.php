				...
				<div class="col-md-6 p-b-30"style="margin:auto;">
					<div class="leave-comment">
						<h4 class="m-text26 p-b-36 p-t-15">
							Infomation Order Cart
						</h4>

						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" id="fullname" placeholder="Full Name">
						</div>
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" id="address" placeholder="Address">
						</div>
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="email" id="email" placeholder="Email">
						</div>
						

						<div class="w-size25">
							<!-- Button -->
							<button class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4 order-now">
								Order Now
							</button>
						</div>
					</div>
