...
<body class="animsition">
	...
	<!-- lide fixed -->
	<?php include "view/layout/slide.php"; ?>
	<!-- h slide fixed -->
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
										<img src="images/<?php echo $value['hinh']?>" alt="IMG-PRODUCT">
										...
										<div class="block2-overlay trans-0-4">
											...
											<div class="block2-btn-addcart w-size1 trans-0-4">
												<!-- Button -->
												<a href="product-detail.php?id_sanpham=<?php echo $value['id_sanpham']?>" style="color:white;" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
													Add to Cart
												</a>
											</div>
										</div>
